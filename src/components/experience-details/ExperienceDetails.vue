    ...
    <div class="experiences-content">
      <div class="experiences-menu">
        <ul>
          <li
            ...
            :class="selectedExperience === experienceKey ? 'menu-selected-value' : 'menu-unselected-value'"
          >
      ...
      <div class="experiences-details">
        <div class="experiences-details-title">
          <h3>{{ t(`experiences.${selectedExperienceKey}.titre_poste`) }} 
            <span class="primary-color-font">@ {{ t(`experiences.${selectedExperienceKey}.name`) }}</span>
          </h3>
          <p>{{ t(`experiences.${selectedExperienceKey}.date_interval`) }}</p>
        </div>
        <div class="experiences-details-missions">
          <ul>
            <li v-for="(mission, index) in tm(`experiences.${selectedExperienceKey}.missions`)" :key="index">
              {{ mission }}
            </li>
          </ul>
        </div>
